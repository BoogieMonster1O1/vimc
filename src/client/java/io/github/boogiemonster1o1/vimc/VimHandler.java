...
public class VimHandler implements Drawable, Widget, Element {
	...
	public void render(DrawContext context, int mouseX, int mouseY, float delta) {
		...
		switch (this.mode) {
			case INSERT ->
				context.drawTextWithShadow(textRenderer, "-- INSERT --", this.getX() + 3, this.getY() + 3, 0xFFFFFFFF);
			case REPLACE ->
				context.drawTextWithShadow(textRenderer, "-- REPLACE --", this.getX() + 3, this.getY() + 3, 0xFFFFFFFF);
			case COMMAND, EXECUTE ->
				context.drawTextWithShadow(textRenderer, this.command, this.getX() + 3, this.getY() + 3, 0xFFFFFFFF);
		}
	}
